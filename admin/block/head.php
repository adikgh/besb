...
<!-- main css -->
<? foreach ($scss as $i): ?> <link rel="stylesheet" type="text/css" href="/admin/assets/css/<?=$i?>.css?v=<?=$ver?>" /> <? endforeach ?>
<? foreach ($css as $i): ?> <link rel="stylesheet" type="text/css" href="/admin/assets/css/<?=$i?>.css?v=<?=$ver?>" /> <? endforeach ?>
...
<script src="/admin/assets/js/fun.js?v=<?=$ver?>"></script>
